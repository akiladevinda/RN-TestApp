  ...
  render() {
    return (
      <View style={styles.container}>
        <Spinner visible={this.props.isLoading} cancelable={false} />
        ...
        <View>
          <Dialog.Container visible={this.props.authError}>
            ...
            <Dialog.Button
              label="Ok"
              onPress={() => this.props.userAuthError(false)}
            />
          </Dialog.Container>
        </View>
        ...
        <View>
          <Dialog.Container visible={this.props.hasError}>
            ...
            <Dialog.Description>Please try again later.</Dialog.Description>
            <Dialog.Button
              label="Ok"
              onPress={() => this.props.loginHasError(false)}
            />
          </Dialog.Container>
        </View>
      </View>
